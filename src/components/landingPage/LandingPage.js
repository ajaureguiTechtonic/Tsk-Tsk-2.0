...
//                   </div>
//                   <div className='col-12 col-sm-2 login-button'>
//                     <button type='button' onClick={(e) => _handleLogIn(this.props, document.getElementById('email').value, document.getElementById('password').value)} className='btn edit-button'>
//                       Get To Work
//                     </button>
//                   </div>
//                 </div>
